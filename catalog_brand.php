...
<body>
    ...
    <!-- This indicates to script the type of our page -->
    <div class="this_page_type" style="display:none;">
        <span>brands</span>
    </div>
    ...
    <div class="container catalog-page">
        <div class="breadcrubms">
            <ul>
                ...
                <?php
                    ...
                    echo '<li><a href="/catalog_brand.php?brand='.$cat.'" id="directory-category">'.$cat.'</a></li>';
                ?>
            </ul>
        </div>
        ...
        <div class="catalog-header-top">
            <?php
                echo '<div class="catalog-heading title" id="catalog-heading-title">'.$cat.'</div>';
            ?> 
        ...
        <?php
                $cat = $_GET['brand'];
                echo '<div class="title title-mob" id="catalog-heading-title-mob">'.$cat.'</div>';
            ?> 
